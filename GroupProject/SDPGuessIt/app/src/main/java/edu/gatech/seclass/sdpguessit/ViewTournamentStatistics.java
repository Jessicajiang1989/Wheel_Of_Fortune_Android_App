...
public class ViewTournamentStatistics extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_view_tournament_statistics);
        DbHelper db = new DbHelper(this);
        GridView statistics = findViewById(R.id.tStatistics);
        ArrayList<String> puzzleStats = new ArrayList<String>();
        puzzleStats = db.getTournamentStatistics();
